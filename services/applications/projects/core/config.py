...
class Settings:
    def __init__(self):
        ...
        self.PROJECT_NAME: str = "Projects Service"
        ...
        self.ADMIN_PROJECTS_TOPIC: str = getenv("ADMIN_PROJECTS_TOPIC")
    ...
    def _print_config_info(self):
        env_vars = {
            ...
            "ADMIN_PROJECTS_TOPIC": self.ADMIN_PROJECTS_TOPIC,
