...
from ..utils import proto_to_health
...
async def get_connections_health(
    ...
    try:
        ...
        return proto_to_health(response)

    except Exception as exc:  # noqa: BLE001
        logger.error("Error getting connections health: %s", exc)
        raise HTTPException(status_code=500, detail="Failed to get connections health") from exc
